...
- __Navigation Bar__
  ...
  - Featured on all 4 pages, the full responsive navigation bar includes links to the Logo, Home page, Gallery and Sign Up page and is identical in each page to allow for easy navigation.
...
- The text for the Home page was taken from Wikipedia - Queen - section 1 History
- The icons in the footer were taken from [Font Awesome](https://fontawesome.com/)

### Media

- The photos used on the hero page are from 
